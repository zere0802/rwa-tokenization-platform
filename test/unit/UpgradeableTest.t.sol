...
contract UpgradeableTest is Test {
    ...
    function testProxyInitialization()
        public
    {
        RWATokenUpgradeableV1 token =
            RWATokenUpgradeableV1(
                address(proxy)
            );
        ...
        public
    {
        ...
        RWATokenUpgradeableV2 tokenV2 =
            RWATokenUpgradeableV2(
                address(proxy)
            );
